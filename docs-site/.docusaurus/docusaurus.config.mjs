...
export default {
  ...
  "organizationName": "web3fuzzforge",
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "F:\\Ігор\\web3-security-test-kit\\docs-site\\sidebars.js",
          "editUrl": "https://github.com/web3fuzzforge/web3-security-test-kit/edit/main/docs-site/"
        },
        "theme": {
          "customCss": "F:\\Ігор\\web3-security-test-kit\\docs-site\\src\\css\\custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Web3FuzzForge. Built with Docusaurus."
    },
    "colorMode": {
      "defaultMode": "light",
      "disableSwitch": false,
